...
import uk.gov.hmrc.constructionindustryscheme.models.requests.ProceedVerificationProxyRequest

class ProceedVerificationProxyRequestSpec extends AnyWordSpec with Matchers {

  "ProceedVerificationProxyRequest (JSON)" should {
    ...
    "read and write with all fields" in {
      ...
      val model = json.as[ProceedVerificationProxyRequest]
    ...
    "fail to read missing instanceId" in {
      ...
      val result = json.validate[ProceedVerificationProxyRequest]
