...
class UpdateContractorSchemeVersionRequestSpec extends SpecBase {

  "UpdateContractorSchemeVersionRequest JSON format" - {
    ...
    "deserialises from JSON" in {
      ...
      json.as[UpdateContractorSchemeVersionRequest] mustBe UpdateContractorSchemeVersionRequest(
        currentVersion = 1,
        instanceId = "abc-123"
      )
    }
