...
class BatchPollerScheduledServiceSpec extends SpecBase with BeforeAndAfterEach {
  ...
  override def beforeEach(): Unit = {
    super.beforeEach()
    org.mockito.Mockito.reset(lockRepository, timestampSupport, appConfig)
  ...
  private def service = new BatchPollerScheduledService(lockRepository, timestampSupport, appConfig)
