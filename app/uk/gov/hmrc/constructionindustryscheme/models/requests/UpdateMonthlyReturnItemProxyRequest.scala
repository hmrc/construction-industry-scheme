...
case class UpdateMonthlyReturnItemProxyRequest(
  instanceId: String,
  taxYear: Int,
  taxMonth: Int,
  amendment: String,
...
object UpdateMonthlyReturnItemProxyRequest:
  given format: OFormat[UpdateMonthlyReturnItemProxyRequest] = Json.format[UpdateMonthlyReturnItemProxyRequest]
